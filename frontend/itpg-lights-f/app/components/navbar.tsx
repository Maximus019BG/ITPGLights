  ...
  return (
    <div>
      <nav className=" pr-24">
        <div>
          <Image1
            className=" relative top-5 left-4 inline-flex items-center justify-between"
            src="/logo.png"
            alt="Logo"
            width={50}
            height={50}
        ...
        <ul className=" relative bottom-8 left-3/4 inline-flex items-center justify-between space-x-16">
          <label className="swap swap-rotate">
            ...
            {/* sun icon */}
            <svg
              className="swap-on fill-current w-10 h-10  text-blue-400"
            ...
            {/* moon icon */}
            <svg
              className="swap-off fill-current w-10 h-10 text-blue-400"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
