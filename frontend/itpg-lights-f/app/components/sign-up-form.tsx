    ...
    <div className="relative left-1/4 top-14">
      ...
      <div className="relative top-32 flex flex-col items-center">
        <label className="input input-bordered flex items-center gap-2 m-3">
          ...
          <input type="text" className="grow" placeholder="Имейл" />
        </label>
        <label className="input input-bordered flex items-center gap-2 m-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <input type="text" className="grow" placeholder="Име и Фамилия" />
        </label>
        <label className="input input-bordered flex items-center gap-2 m-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <input placeholder="Парола" type="password" className="grow"  />
        </label>
        <label className="input input-bordered flex items-center gap-2 m-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <input placeholder="Повторете паролата" type="password" className="grow"  />
        </label>
      </div>
    </div>
  );
